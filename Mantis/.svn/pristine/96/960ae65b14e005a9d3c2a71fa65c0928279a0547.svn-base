 ...
 * @return void
 */
function project_hierarchy_cache( $p_show_disabled = false, $search_condition = array() ) {
 ...
 * @return array
 */
function project_hierarchy_get_subprojects( $p_project_id, $p_show_disabled = false, $search_condition = array() ) {
	global $g_cache_project_hierarchy;

	project_hierarchy_cache( $p_show_disabled, $search_condition );
