...
class IssueNoteCreatedTimelineEvent extends TimelineEvent {
	...
	public function html() {
		...
		$t_html .= '<div class="action">' . sprintf( lang_get( 'timeline_issue_note_created' ), prepare_user_name( $this->user_id, $this->issue_id ), string_get_bug_view_link( $this->issue_id ) ) . '</div>';
