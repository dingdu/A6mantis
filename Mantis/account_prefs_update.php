...
# 预计开始时间和预计结束时间的邮件设置
$t_prefs->email_on_tostart	= gpc_get_bool( 'email_on_tostart' );
$t_prefs->email_on_toend	= gpc_get_bool( 'email_on_toend' );
$t_prefs->email_on_tostart_min_severity	= gpc_get_int( 'email_on_tostart_min_severity' );
$t_prefs->email_on_toend_min_severity	= gpc_get_int( 'email_on_toend_min_severity' );
$t_prefs->email_on_tostart_hours_in_advance	= gpc_get_int( 'email_on_tostart_hours_in_advance' );
$t_prefs->email_on_toend_hours_in_advance	= gpc_get_int( 'email_on_toend_hours_in_advance' );
