...
class UserPreferences {
     ...
     * 当问题预计开始时发送Email提醒
     */
    protected $email_on_tostart = 0;

    /**
     * 当问题预计结束前发送Email提醒
     */
    protected $email_on_toend = 0;

    /**
     * 开始问题邮件的最低严重级别
     */
    protected $email_on_tostart_min_severity = 0;

    /**
     * 结束问题邮件的最低严重级别
     */
    protected $email_on_toend_min_severity = 0;

    /**
     * 当问题预计开始时提前多少小时发送邮件
     */
    protected $email_on_tostart_hours_in_advance = 0;

    /**
     * 当问题预计结束时提前多少小时发送邮件
     */
    protected $email_on_toend_hours_in_advance = 0;
