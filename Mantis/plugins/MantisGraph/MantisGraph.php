...
class MantisGraphPlugin extends MantisPlugin  {
	...
	function hooks() {
		$t_hooks = array(
			...
			'EVENT_USER_COUNT' => 'user_countmenu',
	...
	function summary_submenu() {
		return array(
			'<a class="btn btn-sm btn-primary btn-white" href="' . helper_mantis_url( 'summary_count_page.php' ) . '"> <i class="fa fa-table"></i> ' . lang_get( 'by_user_day_work_hour_count' ) . '</a>',
			'<a class="btn btn-sm btn-primary btn-white" href="' . helper_mantis_url( 'summary_count_user_work_hour_pv_page.php' ) . '"> <i class="fa fa-table"></i> ' . lang_get( 'by_user_month_work_hour_pv_count' ) . '</a>',
			'<a class="btn btn-sm btn-primary btn-white" href="' . plugin_page( 'summary_project_count_page.php' ) . '"> <i class="fa fa-table"></i> ' . lang_get( 'by_project' ) . '</a>',//_month_work_hour_count
			'<a class="btn btn-sm btn-primary btn-white" href="' . helper_mantis_url( 'summary_by_search_bug_page.php' ) . '"> <i class="fa fa-table"></i>按搜索</a>',//_month_work_hour_count
//			'<a class="btn btn-sm btn-primary btn-white" href="' . plugin_page( 'summary_user_count_page.php' ) . '"> <i class="fa fa-table"></i> ' . lang_get( 'by_project_work_hour_count' ) . '</a>',
//			'<a class="btn btn-sm btn-primary btn-white" href="' . plugin_page( 'summary_count_by_reqer_page.php' ) . '"> <i class="fa fa-table"></i> ' . lang_get( 'by_reqer' ) . '</a>',
//			'<a class="btn btn-sm btn-primary btn-white" href="' . plugin_page( 'summary_count_by_dever_page.php' ) . '"> <i class="fa fa-table"></i> ' . lang_get( 'by_dever' ) . '</a>',
//			'<a class="btn btn-sm btn-primary btn-white" href="' . plugin_page( 'summary_count_by_tester_page.php' ) . '"> <i class="fa fa-table"></i> ' . lang_get( 'by_tester' ) . '</a>',
//			'<a class="btn btn-sm btn-primary btn-white" href="' . helper_mantis_url( 'summary_count_page.php' ) . '"> <i class="fa fa-table"></i> ' . lang_get( 'by_user_everyday' ) . '</a>',
//			'<a class="btn btn-sm btn-primary btn-white" href="' . plugin_page( 'summary_count_by_user_page.php' ) . '"> <i class="fa fa-table"></i> ' . lang_get( 'by_user' ) . '</a>',
	 ...
	 * @return array
	 */
	function user_countmenu() {
		return array(
			'<a class="btn btn-sm btn-primary btn-white" href="' . helper_mantis_url( 'user_count_page.php' ) . '"> <i class="fa fa-table"></i> ' . lang_get( 'by_today_project_total' )  . '</a>',
			'<a class="btn btn-sm btn-primary btn-white" href="' . plugin_page( 'user_count_by_project.php' ) . '"> <i class="fa fa-bar-chart"></i> ' . lang_get( 'by_all_project_total' ) . '</a>',
			'<a class="btn btn-sm btn-primary btn-white" href="' . plugin_page( 'summary_user_page.php' ) . '"> <i class="fa fa-bar-chart"></i> ' . lang_get( 'by_user_day_work_hour_count' ) . '</a>',
			'<a class="btn btn-sm btn-primary btn-white" href="' . helper_mantis_url( 'user_project_gantt_page.php' ) . '"> <i class="fa fa-bar-chart"></i> ' . lang_get( 'by_project_gantt' ) . '</a>',
		);
	}
}
