...
//  description
	...
	$t_user_work_log = array(
		...
		'add_time' => strtotime(date("{$due_date} 01:00:00")),
...
// 重新计算 真实 工时
	...
	$t_query = 'INSERT INTO {supply_user_work}
	...
	form_security_purge('supply_user_work');
